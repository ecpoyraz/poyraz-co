  ...
  return (
    <section className="relative flex min-h-[calc(100svh-6.5rem)] flex-col justify-center py-16">
      <div className="max-w-6xl">
        <h1 className="whitespace-nowrap font-display text-[clamp(1.9rem,6.5vw,6rem)] font-normal leading-none tracking-[-0.05em] text-foreground">
          A full stack marketer
        </h1>

        <p className="mt-10 max-w-2xl text-lg leading-relaxed text-muted sm:text-xl md:mt-12 md:text-2xl">
